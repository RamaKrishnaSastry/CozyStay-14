...
with app.app_context():
    ...
    props_data = [
        ...
        {'host': 'Bob Host',   'title': 'City Loft',          'desc': 'Modern loft in downtown with skyline views and rooftop access.', 'price': 180, 'loc': 'New York, NY', 'photos': ['https://picsum.photos/seed/loft1/800/600', 'https://picsum.photos/seed/loft2/800/600'], 'amenities': ['WiFi', 'AC', 'Gym']},
